...
export default function HomePage() {
  ...
  const isResultStep = currentStep === 4 && userType !== "pj";

  const workMinutes = userType === "estagiario" ? 6 * 60 : 8 * 60;
  const endTime = timeUtils.addMinutes(entryTime, workMinutes + breakMinutes);
  const canLeave = isResultStep && timeUtils.isTimeReached(endTime);
